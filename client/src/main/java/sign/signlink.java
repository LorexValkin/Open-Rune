...
public final class signlink implements Runnable {
		...
		for (int i = threadliveid; threadliveid == i;) {
			if (socketreq != 0) {
				...
				try {
					...
					urlstream = null; // URL loading disabled for standalone client
				} catch (Exception _ex) {
					urlstream = null;
				}
				urlreq = null;
	...
	public static String findcachedir() {
		...
		String cacheDir = userHome + File.separator + ".openrune" + File.separator + "cache" + File.separator;
		try {
	...
	public static Object mainapp = null;
