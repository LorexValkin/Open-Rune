		...
		implements ImageProducer, ImageObserver
{
	...
	{
		DrawingArea.initDrawingArea(anInt317, anInt316, pixelData);
	}
	...
	private synchronized void flushPixels()
	{
		...
		{
			anImageConsumer319.setPixels(0, 0, anInt316, anInt317, aColorModel318, pixelData, 0, anInt316);
