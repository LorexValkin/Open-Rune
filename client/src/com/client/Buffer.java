...
public final class Buffer extends DualNode {
  ...
  //  private static final BigInteger RSA_MODULUS = new BigInteger("");
    ...
    public void writeLEShortAlt(int i) {
        buffer[currentOffset++] = (byte) i;
        buffer[currentOffset++] = (byte) (i >> 8);
    }
    ...
    public void writeBytesReversedA(int i, byte abyte0[], int j) {
    ...
    public static final DoublyLinkedList nodeList = new DoublyLinkedList();
