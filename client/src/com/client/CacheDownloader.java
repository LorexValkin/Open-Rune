...
public class CacheDownloader {
	...
	public CacheDownloader downloadCache() {
		// Skip auto-download — cache must be placed manually in %USERPROFILE%/OpenRune/
		if (getCacheLink() == null || getCacheLink().isEmpty()) {
			System.out.println("Cache auto-download disabled. Place cache files in: " + getCacheDir());
			return null;
		}
		try {
