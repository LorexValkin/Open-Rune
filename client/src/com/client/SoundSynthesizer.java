			...
			if (i >= i5 + i6) {
				...
				for (; j7 < l7; j7++) {
					int j8 = (int) ((long) anIntArray115[j7 + i5]
							* (long) AudioFilter.anInt672 >> 16);
					for (int k8 = 0; k8 < i5; k8++)
						j8 += (int) ((long) anIntArray115[(j7 + i5) - 1 - k8]
								* (long) AudioFilter.anIntArrayArray670[0][k8] >> 16);

					for (int j9 = 0; j9 < j7; j9++)
						j8 -= (int) ((long) anIntArray115[j7 - 1 - j9]
								* (long) AudioFilter.anIntArrayArray670[1][j9] >> 16);
					...
					for (; j7 < l7; j7++) {
						...
						for (int k9 = 0; k9 < i5; k9++)
							l8 += (int) ((long) anIntArray115[(j7 + i5) - 1
									- k9]
									* (long) AudioFilter.anIntArrayArray670[0][k9] >> 16);

						for (int i10 = 0; i10 < i6; i10++)
							l8 -= (int) ((long) anIntArray115[j7 - 1 - i10]
									* (long) AudioFilter.anIntArrayArray670[1][i10] >> 16);
				...
				for (; j7 < i; j7++) {
					...
					for (int l9 = (j7 + i5) - i; l9 < i5; l9++)
						i9 += (int) ((long) anIntArray115[(j7 + i5) - 1 - l9]
								* (long) AudioFilter.anIntArrayArray670[0][l9] >> 16);

					for (int j10 = 0; j10 < i6; j10++)
						i9 -= (int) ((long) anIntArray115[j7 - 1 - j10]
								* (long) AudioFilter.anIntArrayArray670[1][j10] >> 16);
	...
	public void method169(Buffer stream) {
		...
		for (int j = 0; j < 10; j++) {
			...
			if (k == 0)
				break;
			anIntArray106[j] = k;
			anIntArray107[j] = stream.readSignedSmart();
			anIntArray108[j] = stream.readUnsignedSmart();
		}

		anInt109 = stream.readUnsignedSmart();
		anInt110 = stream.readUnsignedSmart();
