...
final class BZip2Decompressor {
	...
	private static void method226(BZip2State BZip2State) {
	...
	private static void method227(BZip2State BZip2State) {
		int k8 = 0;
		int ai[] = null;
		int ai1[] = null;
		int ai2[] = null;
		...
		boolean flag19 = true;
		while (flag19) {
			byte byte0 = method228(BZip2State);
			if (byte0 == 23)
				return;
			byte0 = method228(BZip2State);
			byte0 = method228(BZip2State);
			byte0 = method228(BZip2State);
			byte0 = method228(BZip2State);
			byte0 = method228(BZip2State);
			...
			BZip2State.anInt580 = BZip2State.anInt580 << 8 | byte0 & 0xff;
			for (int j = 0; j < 16; j++) {
				byte byte1 = method229(BZip2State);
			...
			for (int l = 0; l < 16; l++)
				if (BZip2State.aBooleanArray590[l]) {
					for (int i3 = 0; i3 < 16; i3++) {
						byte byte2 = method229(BZip2State);
						if (byte2 == 1)
			...
			method231(BZip2State);
			int i4 = BZip2State.anInt588 + 2;
			int j4 = method230(3, BZip2State);
			int k4 = method230(15, BZip2State);
			for (int i1 = 0; i1 < k4; i1++) {
				int j3 = 0;
				do {
					byte byte3 = method229(BZip2State);
					if (byte3 == 0)
						break;
					j3++;
				} while (true);
			...
			for (int k3 = 0; k3 < j4; k3++) {
				int l6 = method230(5, BZip2State);
				for (int k1 = 0; k1 < i4; k1++) {
					do {
						byte byte4 = method229(BZip2State);
						if (byte4 == 0)
							break;
						byte4 = method229(BZip2State);
						if (byte4 == 0)
							l6++;
						else
							l6--;
			...
			for (int l3 = 0; l3 < j4; l3++) {
				...
				method232(BZip2State.anIntArrayArray597[l3],
						BZip2State.anIntArrayArray598[l3],
						BZip2State.anIntArrayArray599[l3],
						BZip2State.aByteArrayArray596[l3], byte8, i, i4);
			...
			int l7;
			byte byte9;
			for (l7 = method230(i7, BZip2State); l7 > ai[i7]; l7 = l7 << 1 | byte9) {
				i7++;
				byte9 = method229(BZip2State);
			}
			...
			for (int k5 = ai2[l7 - ai1[i7]]; k5 != l4;)
				if (k5 == 0 || k5 == 1) {
					...
					do {
						...
						int i8;
						byte byte10;
						for (i8 = method230(j7, BZip2State); i8 > ai[j7]; i8 = i8 << 1
								| byte10) {
							j7++;
							byte10 = method229(BZip2State);
						}
						...
						if (BZip2State.anIntArray593[0] == 0) {
							...
							for (int k9 = 15; k9 >= 0; k9--) {
								for (int l9 = 15; l9 >= 0; l9--) {
									BZip2State.aByteArray592[i10] = BZip2State.aByteArray592[BZip2State.anIntArray593[k9]
											+ l9];
									i10--;
								}
					...
					int j8;
					byte byte11;
					for (j8 = method230(k7, BZip2State); j8 > ai[k7]; j8 = j8 << 1
							| byte11) {
						k7++;
						byte11 = method229(BZip2State);
					}
			...
			method226(BZip2State);
			flag19 = BZip2State.anInt584 == BZip2State.anInt601 + 1
					&& BZip2State.anInt574 == 0;
		}
	}

	private static byte method228(BZip2State BZip2State) {
		return (byte) method230(8, BZip2State);
	}

	private static byte method229(BZip2State BZip2State) {
		return (byte) method230(1, BZip2State);
	}

	private static int method230(int i, BZip2State BZip2State) {
		int j;
		do {
			...
			BZip2State.anInt576 = BZip2State.anInt576 << 8
					| BZip2State.aByteArray563[BZip2State.anInt564] & 0xff;
	...
	private static void method231(BZip2State BZip2State) {
	...
	private static final BZip2State aClass32_305 = new BZip2State();
